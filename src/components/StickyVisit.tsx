...
export default function StickyVisit() {
  ...
  return (
    <div
      className={`fixed bottom-5 right-5 z-40 transition-all duration-300 sm:bottom-7 sm:right-7 ${
        show ? "translate-y-0 opacity-100" : "pointer-events-none translate-y-4 opacity-0"
      }`}
    >
      <BookVisitButton className="flex items-center gap-2.5 rounded-full bg-brass-soft px-5 py-3.5 font-bold text-pine-800 soft-shadow transition-transform duration-300 hover:-translate-y-0.5">
